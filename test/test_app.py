...
def test_valid_event_no_questions_returns_random_question(mocker):
    random_question_mock = mocker.patch(
        'algorithm.choose_random_next_question')
    ...
    expected_topic_id_for_study = {'zc7k2nb': 'z2s8v9q', 'z84jtv4': 'z2s8v9q', 'zs8y4qt': 'z2s8v9q',
                                   'zt8t3k7': 'z9236yc', 'zxr7ng8': 'z9236yc', 'z3tgw6f': 'z9236yc', 'z8fkmsg': 'z9236yc'}

    actual_question = handler(VALID_EVENT_NO_QUESTIONS, CONTEXT)

    random_question_mock.assert_called_with(
        expected_topic_id_for_study, expected_study_guide_list)
