...
def test_get_mastery_band_and_confidence_confident_band1():
    actual_mastery_band, actual_confidence = algorithm.calculate_mastery_band_and_confidence(1 / 6, 0, 4)
...
def test_get_mastery_band_and_confidence_uncertain_band2():
    actual_mastery_band, actual_confidence = algorithm.calculate_mastery_band_and_confidence(2 / 3, 1, 1)
...
def test_get_mastery_band_and_confidence_confident_band2():
    actual_mastery_band, actual_confidence = algorithm.calculate_mastery_band_and_confidence(0.5, 4, 8)
...
def test_get_mastery_band_and_confidence_confident_band3():
    actual_mastery_band, actual_confidence = algorithm.calculate_mastery_band_and_confidence(5 / 6, 4, 4)
