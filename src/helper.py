...
STUDY_GUIDES_IDS_PER_TOPIC_ID = {"z2s8v9q": ["zc7k2nb", "z84jtv4", "zs8y4qt"],
...
TOPIC_ID_PER_STUDY_GUIDE_ID = {"zc7k2nb": "z2s8v9q", "z84jtv4": "z2s8v9q", "zs8y4qt": "z2s8v9q", "zt8t3k7": "z9236yc",
...
def get_study_guide_id_list(topic_ids):
    ...
    for topic_id in topic_ids:
        try:
            ...
            raise Exception(f'[NOT FOUND]: No studyGuideIds found for topicId: {topic_id}')
...
def get_topic_id(study_guide_ids):
    ...
    for study_guide_id in study_guide_ids:
        try:
            ...
            raise Exception(f'[NOT FOUND]: No topicId found for studyGuideId: {study_guide_id}')
