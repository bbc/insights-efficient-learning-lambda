...
def choose_next_question(topic_id_for_study_guide_id, study_guide_id_list, confidence_intervals_list, question_id_list):
    ...
    study_guide_id = __choose_next_study_guide_id(
        study_guide_id_list, probabilities_list)
    ...
    if not filtered_question_id_list:
        filtered_study_guide_id_list, filtered_confidence_intervals_list = __ignore_completed_guide(
            study_guide_id, study_guide_id_list, confidence_intervals_list)

        return choose_next_question(topic_id_for_study_guide_id, filtered_study_guide_id_list,
                                    filtered_confidence_intervals_list, question_id_list)

    question_id = random.choice(filtered_question_id_list)['id']
    question = __get_question_text(
        question_id, study_guide_id, topic_id_for_study_guide_id)

    return question


def __get_question_text(question_id, study_guide_id, topic_id_for_study_guide_id):
...
def __ignore_completed_guide(study_guide_id, study_guide_id_list, confidence_intervals_list):
...
def __choose_next_study_guide_id(study_guide_id_list, probabilities_list):
